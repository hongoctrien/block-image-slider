<!-- BEGIN: main -->
<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/nivoslider/themes/default/default.css" type="text/css" media="screen" />
<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/nivoslider/themes/light/light.css" type="text/css" media="screen" />
<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/nivoslider/themes/dark/dark.css" type="text/css" media="screen" />
<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/nivoslider/themes/bar/bar.css" type="text/css" media="screen" />
<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/nivoslider/nivo-slider.css" type="text/css" media="screen" />
...
<div class="slider-wrapper theme-default">
	...
	<!-- BEGIN: description -->
	<div id="description-{IMAGE.index}" class="nivo-html-caption">
		{IMAGE.description}
	</div>
	<!-- END: description -->
</div>
